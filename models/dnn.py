...
class DNN_model:
    def __init__(self, X, y, load=False):
        """Create Dataset
    ...
    def train(self):
        ...
        loss_graph(self.hist)
        result_graph(self.hist)
    ...
    def create_model(self):
        ...
        model.add(Dense(units=self.n_out, activation=self.last_act))
...
def loss_graph(hist):
    ...
    """
    _, loss_ax = plt.subplots(figsize=(15, 5))
